...
public class TestDebugIdRegistry {
    ...
    public void testUniqueness02() {
         ...
         */
        try {
            objectUnderTest.getDebugId(MessageCodePrefixRegistry.Module.mainwindow, "1");
         ...
         */
        try {
            objectUnderTest.getDebugId(MessageCodePrefixRegistry.Module.mainprocesseditingpanel, "3");
        } catch (final DebugIdUniquenessViolation exception) {
            Assert.fail(exception.getMessage());
        }
    }
    ...
    public void testUnknownKeys() {
        ...
        try {
            objectUnderTest.getDebugId(MessageCodePrefixRegistry.Module.debugids, "An impossible key");
            Assert.fail("No DebugIdUniquenessViolation thrown");
