...
public final class MessageCodePrefixRegistry {
	...
	public enum Module {
		conventions, dailyplanpanel, debugids, editingprocesspanel, embeddedfilereading, estimatedcompletiontimespanel, export2tj3, injectorfactory, jruby, mainprocesseditingpanel, mainwindow, model, persistence, processpanel, projectscheduler, schedulingpanel, tj3bookingsparser, tj3deadlinesparser, workerpanel, version, culture2lang, entrywindow, parameterdatareader, openid
	}
