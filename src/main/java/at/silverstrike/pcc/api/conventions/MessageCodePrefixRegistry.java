...
public final class MessageCodePrefixRegistry {
    ...
    private MessageCodePrefixRegistry() {
        ...
        this.prefixesByModules.put(FunctionalBlock.mainprocesseditingpanel,
                "010");
        ...
        this.prefixesByModules.put(FunctionalBlock.dependencieseditingwindow,
                "026");
        ...
        this.prefixesByModules.put(
                ...
                "038");
        this.prefixesByModules.put(FunctionalBlock.projectnetworkgraphcreator,
                "039");
        this.prefixesByModules.put(
                FunctionalBlock.projectnetworkgraphpanelcontroller,
                "040");
        this.prefixesByModules.put(FunctionalBlock.projecttreemodel, "041");
        this.prefixesByModules.put(FunctionalBlock.taskeditingpanelcontroller,
                "042");
