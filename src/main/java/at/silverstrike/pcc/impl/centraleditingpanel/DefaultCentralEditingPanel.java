...
class DefaultCentralEditingPanel extends Panel implements CentralEditingPanel,
	...
	public void initGui() {
		...
		final List<SchedulingObjectDependencyTuple> tuples = getDependencyTuples();
	...
	private List<SchedulingObjectDependencyTuple> getDependencyTuples() {
		final List<SchedulingObjectDependencyTuple> tuples = new LinkedList<SchedulingObjectDependencyTuple>();
	...
	@Override
	public void setGuiController(final CentralEditingPanelController aController) {
	...
	@Override
	public void eventCreated(final at.silverstrike.pcc.api.model.Event aNewEvent) {
